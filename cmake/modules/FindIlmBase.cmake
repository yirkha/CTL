...
if(PC_ILMBASE_FOUND)
  ...
  elseif(WIN32)
    if("${IlmBase_ROOT}" STREQUAL "")
      message(WARNING "IlmBase_ROOT is not set, the libraries will most probably not be found.")
    else()
      set(_IlmBase_HINT_INCLUDE "${IlmBase_ROOT}/include")
      set(_IlmBase_HINT_LIB "${IlmBase_ROOT}/lib")
      set(CMAKE_MSVCIDE_RUN_PATH "${IlmBase_ROOT}/bin")
    endif()
  endif()
endif()
